...
const Certifications_Form = (props) =>{
    ...
    useEffect(() => {
        if(props.editedTableID!==''){
            ...
            dispatch({ type: `SET_CERT_TITLE`, payload: props.editedTableID['cert_title'] });
    ...
    const submitHandler =(event) =>{
        ...
        if(state.Relationship.length > 0){
            ...
            axios({
                method: "post",
                url: process.env.REACT_APP_USERS_CERTFC_DOCS_INFO,
                        ...
                        <div className={classes.emp_frm_tab_cnt_val}>
                            <div className="row">
                                <div className="col-sm-4">
                                    <label className={classes.margin_0} htmlFor="">Select Course Type<span className='imp_clss'>*</span></label>
                                </div>
                                <div className="col-sm-8">
                                    <select id="Type" name="Relationship" value={state.Relationship} onChange={handleInputChange}  onBlur={handleInputChange} disabled={row_id && true}>
                            ...
                            <div className="row">
                                <div className="col-sm-4">
                                    <label htmlFor="">Certification Title <span className='imp_clss'>*</span></label>
                                </div>
                                <div className="col-sm-8">
...
export default Certifications_Form;