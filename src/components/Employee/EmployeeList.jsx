...
const EmployeeList = () => {
  ...
  return (
    <Fragment>
    {/* {modelshow && <Model title={ModelTitle} onConfirm={() => {setModelShow(false)}}><EmployeeForm editedID={editedId} onChange={() => setDataCanged(true)} onAddRow={closeModel}/></Model>} */}
      <div>
          <div className="page_headers">
              <div className="float-start">
                  <span className="page_headers_title">Employees Management</span>
              </div>
              <div className="float-end">
                  {/* <button type="button" className="add_new" onClick={() => {setModelShow(true); setEnditedIdHander('');}}><AiOutlineUserAdd /> Add Employee</button> */}
                  <button type="button" className="add_new"><AiOutlineUserAdd /> <Link to='/Employee/AddEmployee'>Add Employee</Link></button>
              </div>
          </div>
