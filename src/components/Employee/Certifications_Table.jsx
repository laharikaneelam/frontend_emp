...
import Certifications_Form from './Certifications_Form';
...
const Certifications_Table = (props) =>{
    ...
    const [ModelTitle, SetModelTitle]=useState('Add Certifications');
    ...
    useEffect(() => {
        ...
        axios({
            method: "post",
            url: process.env.REACT_APP_USERS_CERTFC_DOCS_LIST_INFO,
    ...
    const deleteSelected =(e) =>{
        ...
        .then((willDelete) => { 
            ...
            const data_innfo={
              ...
              axios({
                method: "post",
                url: process.env.REACT_APP_USERS_CERTFC_DOCS_DLT_INFO,
                headers: { "content-type": "application/json" },
                data: data_innfo
            })
            .then(result => {
    ...
    return (
        <section>
            {modelshow && <Model title={ModelTitle} onConfirm={() => {setModelShow(false)}}><Certifications_Form editedID={props.editable_id} editedTableID={editedRowId} onAddRow={() => {setModelShow(false)}} onChange={() => setDataCanged(true)} /></Model>}
...
export default Certifications_Table;