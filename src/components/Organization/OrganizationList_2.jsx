      ...
      <div>
          <div className="page_headers">
              <div className="float-start">
                  <span className="page_headers_title">Organisation List</span>
              </div>
          ...
          <div className="table-responsive">
              <div className="org_div_main">
                  <div>
                      ...
                      <div className="org_contnt">
                            <div className="hding">Test Heading</div>
                            <div className="org_crted">Test Heading</div>
                            <div className="org_id"><label htmlFor="">Organisation ID:</label><span>7894165</span></div>
                            <div className="org_edtn"><label htmlFor="">Edition:</label><span>India</span></div>
                            <div className="org_usr_role">Your Admin to this organization</div>
                      </div>
                      <div className="org_bt">
                            <button>Go to organisation</button>
                      </div>
                  </div>
              </div>
              ...
              <tbody>
                  {currentPosts && currentPosts.map((row) => (
                      ...
                      <td>
                        {/* {row.stateid} */}
                          {/* {
                            countrydata.filter((ocuntry) => ocuntry.country_id === row.countryid && ocuntry.states.filter((statev) => statev.state_id === row.stateid).map( (state_n)=>(
                              <span>{state_n.state_name}</span> 
                              )))
                          } */}
