                ...
                <form className={classes.l_form} onSubmit={submitHandler}>
                    <div className={classes.l_form_div}>
                        ...
                        {(usr_status==='' && gst_swith == 'Y') && <div>
                            <input type="file"  id="users_buls" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" onChange={user_excel_Handler} onBlur={user_excel_Handler} className={`${classes.inputText}`}  />
                            <label className={classes.floating_label_no}>
                                Bulk upload users
                            </label>
                        </div>}
